    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">StickerFly</h3>
            <p className="text-gray-300">Premium quality custom die-cut stickers that last over 3 years.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">Email: info@stickerfly.com</p>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-300">© {currentYear} StickerFly. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
